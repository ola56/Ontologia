...
public class WKaDalejThing {
	...
	public static void main(String[] args) {
		try {
			WKaDalejThing window = new WKaDalejThing();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected void createContents() {
	    ...
	    final Menu m = new Menu(shlCdnspl, SWT.BAR);
		   shlCdnspl.setMenuBar(m);
			...
			Label lblWczytajPlik1 = new Label(composite, SWT.NONE);
		 	lblWczytajPlik1.setBounds(10, 10, 411, 55);
		...
		btnNewButton.setBounds(428, 466, 82, 25);
	    ...
	    btnNewButton_1.setBounds(516, 466, 75, 25);
		...
		btnDalej.setBounds(598, 466, 75, 25);
