...
public class DodanieRol {

	protected Shell shlTworzenieKapsuekCdnspl;
	static DodanieRol window = new DodanieRol();
	Display display;
	private Text text;
	static String rola, rolanazwa;
	static String nazwa;
	...
	protected void createContents() {
		...
		btnNewButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
			    ...
			    if (response1 == SWT.YES)
			    {
			       ...
			       EtykietyRole role = new EtykietyRole();
			       role.open();				        	
			    }
		...
		btnZakocz.setBounds(519, 532, 156, 38);
