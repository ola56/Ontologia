...
public class EdyDodanieRol {

	protected Shell shlTworzenieKapsuekCdnspl;
	static EdyDodanieRol window = new EdyDodanieRol();
	Display display;
	private Text text;
	static String rola;
	static String nazwa, nazwar;
	...
	protected void createContents() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if((text.getText() != null || text.getText() != ""))
				{
		   		...
		   		while(classIter.hasNext())
		   			...
		   			if(name != null && name.startsWith("C-"+EdyWyswietl.skrot))
		   			{
			    ...
			    if (response1 == SWT.YES)
			    {
			       ...
			       EdyEtykietyRole role = new EdyEtykietyRole();
			       role.open();				        	
			    }
		...
		lblNewLabel.setBounds(10, 403, 462, 44);
		...
		lblNewLabel_1.setBounds(10, 10, 411, 61);
		...
		btnZakocz.setBounds(528, 532, 147, 36);
		...
		tree_1.addListener(SWT.Selection, new Listener() {
		      ...
		      setRola(nazwaa);
		      text.setText(rola+EdyRole.bytWyd);
		      }
		    });
