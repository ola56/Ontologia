...
public class EdyEtykietyByty {
	...
	public static void main(String[] args) {
		...
		try {
			EdyEtykietyByty window = new EdyEtykietyByty();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
...
protected void createContents() {
	...
	lblDla.setText("Dla: " + EdyRole.byt);
	...
	btnDalej.addSelectionListener(new SelectionAdapter() {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			etykietaenbyt = text_1.getText();
	  		...
	  		EdyRole.ontKlass.addLabel(etykietaplbyt, "pl");
	  		EdyRole.ontKlass.addLabel(etykietaenbyt, "en");
			...
			MessageBox msgBox = new MessageBox(shlCdnspl2, SWT.ICON_QUESTION
		        ...
		        {
		        	shlCdnspl2.dispose();
		        	EdyDodanieRol Dod = new EdyDodanieRol();
		        	Dod.open();				        	
		        }
		        if (response == SWT.NO)
		        {
