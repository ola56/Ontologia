...
public class EdyEtykietyCel {
	...
	public static void main(String[] args) {
		...
		try {
			EdyEtykietyCel window = new EdyEtykietyCel();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
...
protected void createContents() {
	...
	text.setText(EdyWyswietl.nazwaa2);
	...
	lblDla.setText("Dla: " + EdyWyswietl.nazwaa2);
	...
	label.setText("Dla: " + EdyWyswietl.nazwaa1);
	...
	text_2.setText(EdyWyswietl.nazwaa1);
	...
	btnDalej.addSelectionListener(new SelectionAdapter() {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			etykietaenplan = text_3.getText();
	  		...
	  		EdyWyswietl.Cel.addLabel(etykietaplcel, "pl");
	  		EdyWyswietl.Cel.addLabel(etykietaencel, "en");
	  		EdyWyswietl.Plan.addLabel(etykietaplplan, "pl");
	  		EdyWyswietl.Plan.addLabel(etykietaenplan, "en");
			...
			dialog.open();
	  		...
	  		shlCdnspl2.dispose();
	  		EdyWyswietl wyswietl = new EdyWyswietl();
	  		wyswietl.open();
