...
public class WKaEtykietyByty {
	...
	public static void main(String[] args) {
		...
		try {
			WKaEtykietyByty window = new WKaEtykietyByty();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
...
protected void createContents() {
	...
	lblWpiszNazwSytuacji.setText("Podaj etykiety dla utworzonego bytu wydarzaj\u0105cego si\u0119. Je\u015Bli pobrane\nautomatycznie nazwy Ci nie odpowiadaj\u0105, mo\u017Cesz edytowa\u0107 i poda\u0107\nw\u0142asne. Etykieta w j\u0119zyku angielskim nie jest autouzupe\u0142niona");
	...
	btnDalej.addSelectionListener(new SelectionAdapter() {
		@Override
		public void widgetSelected(SelectionEvent e) {
			String etykietaplbyt="";
			String etykietaenbyt="";
			
	  		
			etykietaplbyt = text.getText();
			etykietaenbyt = text_1.getText();
	  		...
	  		WKaRole.ontKlass.addLabel(etykietaplbyt, "pl");
	  		WKaRole.ontKlass.addLabel(etykietaenbyt, "en");
			...
			MessageBox msgBox = new MessageBox(shlCdnspl2, SWT.ICON_QUESTION
		            | SWT.YES | SWT.NO);
		        ...
		        {
		        	shlCdnspl2.dispose();
		        	WKaRole role = new WKaRole();
		        	role.open();
		        	
		        }
		        
	  		//shlCdnspl2.dispose();
	  		//EdyRole wyswietl = new EdyRole();
	  		//wyswietl.open();
