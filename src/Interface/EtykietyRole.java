...
public class EtykietyRole {
	...
	public static void main(String[] args) {
		...
		try {
			EtykietyRole window = new EtykietyRole();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
...
protected void createContents() {
	...
	text.setText(DodanieRol.rolanazwa);
	...
	lblDla.setText("Dla: " + DodanieRol.rolanazwa);
	...
	btnDalej.addSelectionListener(new SelectionAdapter() {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			etykietaenrola = text_1.getText();
	  		...
	  		DodanieRol.ontKlass.addLabel(etykietaplrola, "pl");
	  		DodanieRol.ontKlass.addLabel(etykietaenrola, "en");
