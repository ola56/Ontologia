...
public class WKaEtykietyCel {
	...
	public static void main(String[] args) {
		...
		try {
			WKaEtykietyCel window = new WKaEtykietyCel();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
...
protected void createContents() {
	...
	text.setText(WKaWyswietl.nazwaa);
	...
	lblDla.setText("Dla: " + WKaWyswietl.nazwaa);
	...
	label.setText("Dla: " + WKaWyswietl.nazwaa1);
	...
	text_2.setText(WKaWyswietl.nazwaa1);
	...
	btnDalej.addSelectionListener(new SelectionAdapter() {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			etykietaenplan = text_3.getText();
	  		...
	  		WKaWyswietl.Cel.addLabel(etykietaplcel, "pl");
	  		WKaWyswietl.Cel.addLabel(etykietaencel, "en");
	  		WKaWyswietl.Plan.addLabel(etykietaplplan, "pl");
	  		WKaWyswietl.Plan.addLabel(etykietaenplan, "en");
