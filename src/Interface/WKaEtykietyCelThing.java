...
public class WKaEtykietyCelThing {
	protected Shell shlCdnspl2;
	Display display;
	private Text text;
	private Text txtGoaloftheplanof;
	...
	public static void main(String[] args) {
		...
		try {
			WKaEtykietyCelThing window = new WKaEtykietyCelThing();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
...
protected void createContents() {
	...
	text.setText(WKaWyswietlThing.nazwaa);
	...
	txtGoaloftheplanof = new Text(composite, SWT.BORDER);
	txtGoaloftheplanof.setBounds(10, 177, 239, 21);
	txtGoaloftheplanof.setFont(SWTResourceManager.getFont("Exo 2 Light", 9, SWT.NORMAL));
	txtGoaloftheplanof.setText("GoalOfThePlanOf");
	
	Label lblDla = new Label(composite, SWT.NONE);
	lblDla.setText("Dla: " + WKaWyswietlThing.nazwaa);
	...
	label.setText("Dla: " + WKaWyswietlThing.nazwaa1);
	...
	text_2.setText(WKaWyswietlThing.nazwaa1);
	...
	btnDalej.addSelectionListener(new SelectionAdapter() {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			etykietaencel = txtGoaloftheplanof.getText();
			...
			etykietaenplan = text_3.getText();
	  		...
	  		WKaWyswietlThing.Cel.addLabel(etykietaplcel, "pl");
	  		WKaWyswietlThing.Cel.addLabel(etykietaencel, "en");
	  		WKaWyswietlThing.Plan.addLabel(etykietaplplan, "pl");
	  		WKaWyswietlThing.Plan.addLabel(etykietaenplan, "en");
			...
			dialog.open();
	  		...
	  		shlCdnspl2.dispose();
	  		WKaWyswietlThing wyswietl = new WKaWyswietlThing();
	  		wyswietl.open();
