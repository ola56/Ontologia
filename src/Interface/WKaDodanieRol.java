...
public class WKaDodanieRol {

	protected Shell shlTworzenieKapsuekCdnspl;
	static WKaDodanieRol window = new WKaDodanieRol();
	Display display;
	private Text text;
	static String rola;
	...
	protected void createContents() {
		...
		btnNewButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
			    ...
			    if (response1 == SWT.YES)
			    {
			       ...
			       WKaEtykietyRole role = new WKaEtykietyRole();
			       role.open();				        	
			    }
		...
		btnZakocz.setBounds(528, 532, 147, 31);
		...
		tree_1.addListener(SWT.Selection, new Listener() {
		      ...
		      setRola(nazwaa);
		      text.setText(rola+WKaRole.bytWyd);
		      }
		    });
