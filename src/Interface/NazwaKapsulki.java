...
public class NazwaKapsulki {
	...
	public static void main(String[] args) {
		...
		try {
			NazwaKapsulki window = new NazwaKapsulki();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
...
protected void createContents() {
	...
	lblNazwaPolska.setBounds(10, 54, 215, 15);
	...
	lblNazwaAngielskaEnglishname.setBounds(10, 102, 231, 21);
	...
	text_1.setBounds(10, 129, 245, 21);
	...
	btnDalej.addSelectionListener(new SelectionAdapter() {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			String[] litery = {"TD", "TS", "E", "C", "K", "I", "D", "A", "S"};
	  		...
	  		nazwa=nazwaa.substring(15, dlu1);
	  		char znak;
	  		...
	  		cdnspl.addLabel("cDnSPL-Sytuacji" + nazwa, "pl");
	  		cdnspl.addLabel("cDnSPL-SituationOf" + tlumaczenie, "en");
	  		Elcdnspl.addLabel("Element-cDnSPL-Sytuacji" + nazwa, "pl");
	  		...
	  		{
	  			klas[i] = WczytajWarstwe.model.createClass(WczytajWarstwe.MyUri + "#" + litery[i] + "-" + skrot);
	  			NazwaKapsulki.Elcdnspl.addSubClass(klas[i]);
	  			klas[i].addLabel(litery[i]+"-Sytuacji" + nazwa, "pl");
	  			klas[i].addLabel(litery[i]+"-SituationOf" + tlumaczenie, "en");
	  		}
	  		
	  		BudowaKapsulki BD = new BudowaKapsulki(WczytajWarstwe.model, klas, WczytajWarstwe.MyUri, cdnspl, Elcdnspl);
