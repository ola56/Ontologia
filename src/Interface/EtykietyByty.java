...
public class EtykietyByty {
	...
	public static void main(String[] args) {
		...
		try {
			EtykietyByty window = new EtykietyByty();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	btnDalej.addSelectionListener(new SelectionAdapter() {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			etykietaenbyt = text_1.getText();
	  		...
	  		Role.ontKlass.addLabel(etykietaplbyt, "pl");
	  		Role.ontKlass.addLabel(etykietaenbyt, "en");
