...
public class WKaEtykietyRole {
	...
	public static void main(String[] args) {
		...
		try {
			WKaEtykietyRole window = new WKaEtykietyRole();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
...
protected void createContents() {
	...
	text.setText(WKaDodanieRol.rolanazwa);
	...
	lblDla.setText("Dla: " + WKaDodanieRol.rolanazwa);
	...
	btnDalej.addSelectionListener(new SelectionAdapter() {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			etykietaenrola = text_1.getText();
	  		...
	  		WKaDodanieRol.ontKlass.addLabel(etykietaplrola, "pl");
	  		WKaDodanieRol.ontKlass.addLabel(etykietaenrola, "en");
			...
			dialog.open();
	  		...
	  		shlCdnspl2.dispose();
	  		WKaDodanieRol role = new WKaDodanieRol();
	  		role.open();
