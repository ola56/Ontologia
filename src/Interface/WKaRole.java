...
public class WKaRole {

	protected Shell shlTworzenieKapsuekCdnspl;
	static WKaRole window = new WKaRole();
	Display display;
	private Text text;
	...
	protected void createContents() {
			...
			public void widgetSelected(SelectionEvent e) {
				if((text.getText() != null || text.getText() != ""))
				{
		   		...
		   		while(classIter.hasNext())
		   			...
		   			if(ontClass.getLocalName() != null && ontClass.getLocalName().startsWith("C-"+WKaNazwaKapsulki.skrot))
		   			{
			    ...
			    if (response1 == SWT.YES)
			    {
			       ...
			       WKaEtykietyByty byt = new WKaEtykietyByty();
			       byt.open();				        	
			    }
				...
				MessageBox msgBox = new MessageBox(shlTworzenieKapsuekCdnspl, SWT.ICON_QUESTION
			        ...
			        {
			        	shlTworzenieKapsuekCdnspl.dispose();
			        	WKaDodanieRol rola = new WKaDodanieRol();
			        	rola.open();				        	
			        }
			    }
				}
		...
		btnNewButton_1.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				dialog.setMessage("Tutaj mo¿esz dodaæ pojêcia odpowiadaj¹ce bytom wydarzaj¹cym. S¹ to: OpisStanu, OpisZdarzenia, OpisAktywnosci oraz Zadanie.\nZosta³y one podane po prawej stronie. "
						...
						+ "Ni¿ej zosta³ zamieszczony przycisk \"Usuñ\", który usunie pojêcie zaznaczone w widoku ontologii, pod pojêciem C-"+WKaNazwaKapsulki.skrot
						+ "\r\nKlikaj¹c przycisk \"Dalej\" przejdziesz do reifikacji \n(dodawanie pojêæ do E-"+WKaNazwaKapsulki.skrot+" i C-"+WKaNazwaKapsulki.skrot+")");
				dialog.open();
			}
		});
		...
		btnNewButton_2.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
			     ...
			     OntClass ontClass1 = WczytajPlik.modelnowy.getOntClass(WczytajPlik.MyUrinowy + "#C-" + WKaNazwaKapsulki.skrot);
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				shlTworzenieKapsuekCdnspl.dispose();
				WKaReifikacja reifikacja = new WKaReifikacja();
				reifikacja.open();
			}
		});
	...
	public void refresh(Tree tree){
		...
		while (classIter.hasNext()) 
		{
			...
			if ((uri != null && uri.startsWith("Element-cDnSPL-Sytuacji" + WKaNazwaKapsulki.nazwa1)) )
				{
