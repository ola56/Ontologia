...
public class WKaWyswietl {
	...
	Tree tree;
	String skrot = WKaNazwaKapsulki.skrot;
	static String cel="";
	static String plan="";
	...
	public static void main(String[] args) {
		try {
			WKaWyswietl window = new WKaWyswietl();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected void createContents() {
		...
		lblPodajPlanReprezentujcy.setBounds(10, 310, 366, 15);
		...
		btnDodaj.setBounds(381, 329, 75, 25);
		btnDodaj.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
		  		...
		  		//Cel.addLabel("CelPlanu" + cel + WKaNazwaKapsulki.nazwa1, "pl");
		  		//Cel.addLabel("Cel" + cel + WKaNazwaKapsulki.nazwa1, "en");
		  		//Plan.addLabel("Plan" + plan + WKaNazwaKapsulki.nazwa1, "pl");
		  		//Plan.addLabel("Plan" + plan + WKaNazwaKapsulki.nazwa1, "en");
			    ...
			    {
			       shlCdnspl.dispose();
			       WKaEtykietyCel Dod = new WKaEtykietyCel();
			       Dod.open();				        	
			    }
		...
		btnNewButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				MessageBox dialog = new MessageBox(shlCdnspl);
				dialog.setMessage("W tym oknie zostanie przeprowadzona specjalizacja elementu D-"+WKaNazwaKapsulki.skrot+" czyli zostan¹ dodane do D-"+WKaNazwaKapsulki.skrot+" pojêcia zwi¹zane z planem oraz celem sytuacji, której dotyczy kapsu³ka.\r\n"
						...
						+ "Po klikniêciu \"Dodaj\" podany Cel oraz Plan zostan¹ dodane do elementu D-"+WKaNazwaKapsulki.skrot+" i widok ontologii sie zaktualizuje o podan¹ zmiane. \r\n"
	...
	Iterator classIter = WczytajPlik.modelnowy.listClasses();
		...
		while (classIter.hasNext()) 
		{
			...
			if ((uri != null  && uri.startsWith("cDnSPL-Sytuacji" + WKaNazwaKapsulki.nazwa1)) 	|| (uri != null && uri.startsWith("Element-cDnSPL-Sytuacji" + WKaNazwaKapsulki.nazwa1)) || (uri != null && ontClass.isHierarchyRoot()))
				{
