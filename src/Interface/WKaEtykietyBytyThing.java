...
public class WKaEtykietyBytyThing {
	...
	public static void main(String[] args) {
		...
		try {
			WKaEtykietyBytyThing window = new WKaEtykietyBytyThing();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
...
protected void createContents() {
	...
	lblDla.setText("Dla: " + WKaRoleThing.byt);
	...
	btnDalej.addSelectionListener(new SelectionAdapter() {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			etykietaenbyt = text_1.getText();
	  		...
	  		WKaRoleThing.ontKlass.addLabel(etykietaplbyt, "pl");
	  		WKaRoleThing.ontKlass.addLabel(etykietaenbyt, "en");
