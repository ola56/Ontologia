...
public class EdyEtykietyRole {
	...
	public static void main(String[] args) {
		...
		try {
			EdyEtykietyRole window = new EdyEtykietyRole();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
...
protected void createContents() {
	...
	text.setText(EdyDodanieRol.nazwar);
	...
	lblDla.setText("Dla: " + EdyDodanieRol.nazwar);
	...
	btnDalej.addSelectionListener(new SelectionAdapter() {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			etykietaenrola = text_1.getText();
	  		...
	  		EdyDodanieRol.ontKlass.addLabel(etykietaplrola, "pl");
	  		EdyDodanieRol.ontKlass.addLabel(etykietaenrola, "en");
			...
			dialog.open();
	  		...
	  		shlCdnspl2.dispose();
	  		EdyDodanieRol role = new EdyDodanieRol();
	  		role.open();
