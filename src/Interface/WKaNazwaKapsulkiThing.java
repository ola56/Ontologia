...
public class WKaNazwaKapsulkiThing {
	...
	public static void main(String[] args) {
		...
		try {
			WKaNazwaKapsulkiThing window = new WKaNazwaKapsulkiThing();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
...
protected void createContents() {
	...
	lblWpiszNazwSytuacji.setBounds(10, 10, 473, 39);
	...
	lblNazwaAngielskaEnglishname.setBounds(10, 102, 215, 21);
	...
	text_1.setBounds(10, 129, 215, 21);
		...
		public void widgetSelected(SelectionEvent e) {
			...
			String nazwaa=text.getText();
	  		...
	  		for (int i = 0; i< litery.length; i++)
	  		{
	  			...
	  			WKaNazwaKapsulkiThing.Elcdnspl.addSubClass(klas[i]);
